...
<form method="get" action="/main/test/result">
    <img src="/images/Test.jpg" width="1518" height="609"/>
    <div class="text_block" style="margin-top: 30px">
        Если ты хочешь зайти в IT-сферу, но не знаешь, какое направление выбрать, мы тебе поможем! Нужно всего лишь
        ответить на вопросы ниже, и по итогу ты узнаешь, какая профессия подойдет именно тебе.
    </div>
    ...
    <div class="form_column">
        ...
        <div class="form_radio">
            ...
            <label for="radio-1">Люблю многозадачность: больше продуктивных митингов, планов и эффективных
                решений</label>
        </div>
        <div class="form_radio">
        ...
        <div class="form_radio">
            ...
            <label for="radio-1">Когда все идеи, даже самые нестандартные, принимают во внимание, а творческий подход
                только поощеряется</label>
        </div>
    </div>
    ...
    <div class="form_column">
        ...
        <div class="form_radio">
            ...
            <label for="radio-1">Подойду к проблеме креативно: например, сделаю так, чтобы ошибка не бросалась в
                глаза</label>
        </div>
    </div>
